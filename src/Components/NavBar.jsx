      ...
      <nav className="fixed top-3 left-0 w-full bg-transparent shadow-md z-50">
        <div className="flex items-center justify-around px-6 py-3 relative">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <Link
              to="/Bootcamp"
              className="border-2 border-[#ec1a63] text-[#ec1a63] text-lg font-medium px-3 py-1 rounded-lg hover:bg-[#ec1a63] hover:text-white hover:scale-105 transform transition duration-300 ease-in-out shadow-lg"
            >
              Bootcamp
            </Link>
          </div>
